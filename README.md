<h1 align="center">Hi , I'm JoseeMelk <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
...
- :school: I'm a full-stack developer with experience in **PHP (Laravel)**, **Python (Django/Flask)**, and modern web development.  
- :trophy: I’ve built real-world projects including **legal case management systems**, **administrative platforms**, and **MikroTik integrations**.  
- :technologist: I love using software to solve **real-life problems** with clean and efficient solutions.  
- :computer: My main focus is backend development, RESTful APIs, and system architecture.
- :student: Currently learning more about **software architecture**, **distributed databases**, and **backend best practices**.  
- :nerd_face: Always curious and constantly learning new technologies.  
- :thinking: I’m open to new **job opportunities** in backend or full-stack development.
- :boom: Personal website/portfolio coming soon.
<br>
...
![Terminal](https://img.shields.io/badge/Terminal-%23054020.svg?style=for-the-badge&logo=windows-terminal&logoColor=white)
![Nano](https://img.shields.io/badge/Nano-%230075C2.svg?style=for-the-badge&logo=nano&logoColor=white)
</p>
<br> 
